        ...
        <div className={"container mx-auto flex flex-col items-center gap-4 pb-10"}>
            ...
            <div className={"w-3/5 flex flex-col gap-4"}>
                <p className={"text-lg text-black font-medium text-center"}>
                    ...
                    other <strong className={"text-blue-800"}>Web Development</strong> Technologies. I also want to explore <strong className={"text-blue-800"}>Data Science</strong> as a career option. I love <strong className={"text-orange-500"}>music</strong>, <strong className={"text-orange-500"}>art</strong> and <strong className={"text-orange-500"}>reading books</strong>.
                </p>
